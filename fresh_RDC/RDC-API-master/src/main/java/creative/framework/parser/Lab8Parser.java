...
public class Lab8Parser implements Parser<Scene> {
    ...
    public Lab8Parser() {
        ...
        attributes.put("inspiration_size:citiscape", index++);
        attributes.put("inspiration_size:small_town_suburb", index++);
        attributes.put("inspiration_size:streetview", index++);
        attributes.put("inspiration_size:other", index++);
        attributes.put("inspiration_water:canal", index++);
        attributes.put("inspiration_water:lake", index++);
        attributes.put("inspiration_water:river", index++);
        attributes.put("inspiration_water:ocean", index++);
        attributes.put("inspiration_water:none", index++);
        attributes.put("inspiration_water:island", index++);
        attributes.put("inspiration_water:nondescript_body_in_city", index++);
        attributes.put("inspiration_park:yes_park", index++);
        attributes.put("inspiration_park:no_park", index++);
        attributes.put("city_size:citiscape", index++);
        attributes.put("city_size:small_town_suburb", index++);
        attributes.put("city_size:streetview", index++);
        attributes.put("city_size:other", index++);
        attributes.put("color_synergy:yes", index++);
        attributes.put("color_synergy:no", index++);
        attributes.put("height_variation:yes_height", index++);
        attributes.put("height_variation:no_height", index++);
        attributes.put("inspiration_height_variation:yes_height", index++);
        attributes.put("inspiration_height_variation:no_height", index++);        
